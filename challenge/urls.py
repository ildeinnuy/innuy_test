...
from notifications.api.views import NotificationApiView
...
urlpatterns = [
    ...
    path("api/v1/notification/", NotificationApiView.as_view(), name="notification"),
    path(r"", include("react.urls"), name="react"),
